...
const { searchFankai, getFullAnimeDetails } = require('./fankai');
...
const manifest = {
    ...
    background: '', 
    catalogs: [
        { id: 'fankai-tout', name: 'Fan-Kai', type: 'fankai', extra: [ { name: 'search', isRequired: false } ] }
    ],
