...
const manifest = {
    ...
    catalogs: [
        { 
            ...
            genres: ['Action', 'Aventure', 'Comédie', 'Drame', 'Fantasy', 'Horreur', 'Mystère', 'Psychologique', 'Romance', 'Sci-Fi', 'Slice of Life', 'Sport', 'Surnaturel', 'Shonen', 'Shojo', 'Seinen', 'Josei', 'Arts Martiaux', 'Ninja', 'Pirates', 'Super-héros', 'Cuisine', 'Ecchi', 'Post-apocalyptique', 'Steampunk', 'Historique']
        },
        { 
            id: 'fankai-terminees', 
            name: 'Terminées', 
