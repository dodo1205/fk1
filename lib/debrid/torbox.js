        ...
        try {
            ...
            while (Date.now() - startTime < pollingTimeout) {
                ...
                if (torrentInfo && torrentInfo.files && torrentInfo.files.length > 0) {
                    console.log(`[Torbox] Torrent ${torrentId} prêt avec ${torrentInfo.files.length} fichier(s).`);
                ...
                console.log(`[Torbox] Attente... ID: ${torrentId}, Statut: ${torrentInfo ? torrentInfo.download_state : 'N/A'}`);
