...
class Torbox extends DebridService {
    ...
    async getStreamableLinkForMagnet(magnetLink, fileIndex, season, episodeNumber, streamType, episodeName, options = {}) {
        ...
        try {
            // La logique est maintenant unifiée. On ajoute toujours le torrent.
            // Si le torrent est déjà sur le compte, l'API Torbox devrait le gérer.
            // Si le torrent est en cache global, l'ajout sera quasi-instantané.
