    ...
    async getStreamableLinkForMagnet(magnetLink, fileIndex, season, episodeNumber, streamType, episodeName, options = {}) {
        ...
        try {
            ...
            if (existingTorrent) {
                ...
                // Vérifier avec une liste fraîche après l'ajout
                ...
                for (let attempt = 0; attempt < 5; attempt++) {
                    ...
                    try {
                        // Récupérer une nouvelle liste fraîche
                        ...
                        if (foundTorrent) {
                            ...
                            console.log(`[Torbox] Statut du torrent trouvé: "${foundTorrent.status || 'VIDE'}", Progression: ${foundTorrent.progress || 0}%`);
                            torrentFound = true;
                ...
                const status = (existingTorrent.status || 'processing').toLowerCase().trim();
