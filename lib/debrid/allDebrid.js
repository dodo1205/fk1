...
class AllDebrid extends DebridService {
    ...
    async checkApiKey() {
        // Torrentio ne fait pas de vérification de clé explicite pour AllDebrid en amont.
        // Il tente l'opération et gère les erreurs d'authentification par la suite.
        // Nous allons adopter cette approche.
        console.log('[FK AllDebrid] checkApiKey: Returning true, actual validation on API call.');
        return true; 
    }
